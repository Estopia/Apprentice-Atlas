...
const styles = StyleSheet.create({ container: { gap: 10, paddingVertical: 12 }, inputs: { flexDirection: 'row', gap: 10 }, input: { flex: 1, backgroundColor: '#fff', borderWidth: 1, borderColor: '#e6e1da', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 11, minHeight: 44 }, label: { fontWeight: '700', color: '#36534b' }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, chip: { minHeight: 44, paddingHorizontal: 14, paddingVertical: 10, justifyContent: 'center', borderRadius: 999, backgroundColor: '#edf1ee' }, active: { backgroundColor: '#173b35' }, chipText: { color: '#36534b', fontWeight: '600' }, activeText: { color: '#fff' } });
