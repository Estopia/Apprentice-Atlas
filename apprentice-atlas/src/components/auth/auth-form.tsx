...
const styles = StyleSheet.create({ form: { width: '100%', maxWidth: 430, gap: 12 }, switcher: { flexDirection: 'row', gap: 8, marginBottom: 4 }, mode: { flex: 1, padding: 11, borderRadius: 10, backgroundColor: '#e9f1ed', alignItems: 'center' }, modeActive: { backgroundColor: '#173b35' }, modeText: { color: '#36534b', fontWeight: '800' }, modeTextActive: { color: '#fff' }, input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#ddd7ce', borderRadius: 10, paddingHorizontal: 13, paddingVertical: 12 }, error: { color: '#b33e2e' }, notice: { color: '#36534b' }, submit: { backgroundColor: '#d95d39', borderRadius: 10, alignItems: 'center', padding: 13 }, submitText: { color: '#fff', fontWeight: '800' } });
