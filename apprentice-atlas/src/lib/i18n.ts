...
const messages = {
  de: {
    ...
    'prepare.privateNote': 'Dein Hintergrund bleibt als Entwurf auf diesem Gerät. Er wird nur zur Erstellung an die geschützte Funktion gesendet.',
  ...
  en: {
    ...
    'prepare.privateNote': 'Your background stays as a draft on this device. It is sent only to the protected function when you generate preparation.',
