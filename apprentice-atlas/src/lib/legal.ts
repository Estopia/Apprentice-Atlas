  ...
  de: {
    privacy: {
      ...
      sections: [
        ...
        { heading: 'Dienste und Empfänger', paragraphs: ['Supabase stellt Anmeldung, Datenbank und Serverfunktionen bereit. Kontodaten werden in der EU-Region verarbeitet. OpenAI verarbeitet Stelleninhalte und deine freiwilligen Fragen, um Erklärungen und Antworten zu erzeugen; API-Antworten werden mit deaktivierter Speicherung angefordert. Apple verarbeitet Daten, wenn du „Mit Apple anmelden“ nutzt. Beim Öffnen einer offiziellen Anzeige gelten die Hinweise des jeweiligen Stellenanbieters.'] },
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: 'KI-Hilfe', paragraphs: ['KI-Erklärungen und Antworten werden aus dem Inhalt der Stellenanzeige erzeugt. Sie können unvollständig oder falsch sein. Prüfe wichtige Angaben immer in der Originalanzeige und frage den Arbeitgeber. Teile keine sensiblen persönlichen Daten in KI-Fragen.'] },
  ...
  en: {
    privacy: {
      ...
      sections: [
        ...
        { heading: 'Providers and recipients', paragraphs: ['Supabase provides authentication, database, and server functions. Account data is processed in the EU region. OpenAI processes job content and questions you choose to ask to produce explanations and answers; API responses are requested with storage disabled. Apple processes data when you use Sign in with Apple. When you open an official listing, that provider’s privacy terms apply.'] },
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: 'AI assistance', paragraphs: ['AI explanations and answers are generated from the job listing. They may be incomplete or wrong. Always verify important details in the original listing and with the employer. Do not share sensitive personal data in AI questions.'] },
